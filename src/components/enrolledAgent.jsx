...
<div className="">
  ...
  <div className="flex flex-col sm:flex-row mt-12 w-full"> 
	...
	<div className="container mx-auto flex flex-col items-center justify-center p-4 space-y-8 md:p-10 lg:space-y-0 lg:flex-row lg:justify-between">
		<h1 className="text-3xl font-semibold leading-tight text-center lg:text-left">Need  Consultant ?</h1>
		<button className="px-8 py-3 text-lg font-semibold rounded bg-sky-600 text-gray-50">Contact</button>
	</div>
</section>
      </div>
