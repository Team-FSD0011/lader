    ...
    <>
      ...
      <div className="flex flex-col md:flex-row">
        <img
          src={welcome1}
          alt=""
          className="md:ml-14 h-64 w-80 rounded-xl md:mt-20"
        />
      ...
      <div className="bg-grey-400">
        <div className="flex">
          ...
          <div>
            ...
            <p className="text-lg md:mt-10  md:mr-40 md:ml-20 font-serif text-justify">
              Vision: To become the leading Overseas Education Consulting
              Organization for overseas education by providing customized
              solutions to students who aspire to study abroad.
            </p>
            <p className="text-lg md:mt-3  md:mr-40 md:ml-20 font-serif text-justify">
