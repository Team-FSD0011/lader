        ...
        <>
            ...
            <div className="flex flex-col md:flex-row mt-10">
                ...
                <div className="md:ml-4 md:mr-10">
                    ...
                    <ul className="text-lg mt-10 md:mt-0 mr-4 md:mr-10 md:ml-0 text-justify ">
