...
import aus from '../component/image/aus aus.jpeg';
import unsw from '../component/image/unsw aus.jpeg';
import vienna from '../component/image/vienna aus.jpeg';
import v2 from '../component/image/v2.png';
import unsw3 from '../component/image/unsw3.png';
import aus01 from '../component/image/aus01.png';
import AOS from 'aos';
    ...
    <div className="container-fluid bg-img" id="home">
         <div className="container home relative">
            ...
            <img
              ...
              alt=""
              className="scroll-smooth  h-[400px] relative w-full  object-cover"
            />
...
<h2 className='text-blue-500 font-bold text-3xl font-italic mt-5 sm:mt-10 text-center font-serif'>Australia Study Options</h2>
...
<div className="relative mt-20">
  ...
  <div className="absolute top-10 left-0 md:left-10 md:top-20 lg:top-24">
    ...
    <div className="max-w-sm rounded-lg overflow-hidden shadow-xl h-auto sm:h-[420px] w-auto sm:w-[400px] mt-5 sm:mt-12">
        <img src={aus} alt="" className="w-full h-48 sm:h-[200px] object-cover rounded-t-lg" />
    ...
    <div className="max-w-sm rounded-lg overflow-hidden shadow-xl h-auto sm:h-[420px] w-auto sm:w-[400px] mt-5 sm:mt-12">
        <img src={unsw} alt="" className="w-full h-48 sm:h-[200px] object-cover rounded-t-lg" />
        <div className="px-6 py-4">
    ...
    <div className=" ">
    <div className="max-w-sm rounded-lg overflow-hidden shadow-xl h-auto sm:h-[420px] w-auto sm:w-[400px] mt-5 sm:mt-12">
        <img src={vienna} alt="" className="w-full h-48 sm:h-[200px] object-cover rounded-t-lg" />
        <div className="px-6 py-4">
